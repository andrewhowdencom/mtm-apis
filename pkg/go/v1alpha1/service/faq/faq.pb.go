...
/*
Package faq is a generated protocol buffer package.
...
func init() {
	proto.RegisterType((*GetFaqRequest)(nil), "v1alpha1.service.GetFaqRequest")
}
...
func (c *faqServiceClient) GetFaq(ctx context.Context, in *GetFaqRequest, opts ...grpc.CallOption) (*Faq, error) {
	out := new(Faq)
	err := grpc.Invoke(ctx, "/v1alpha1.service.FaqService/GetFaq", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FaqService_GetFaq_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1alpha1.service.FaqService/GetFaq",
	}
...
var _FaqService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "v1alpha1.service.FaqService",
...
var fileDescriptor0 = []byte{
	...
	0x2c, 0xd4, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x80, 0x49, 0xea, 0x41, 0x25, 0xa5, 0x24,
	0xe0, 0xca, 0x4b, 0x2a, 0x0b, 0x90, 0xd5, 0x4a, 0xc9, 0xa4, 0xe7, 0xe7, 0xa7, 0xe7, 0xa4, 0xea,
	...
	0x35, 0x38, 0x83, 0x58, 0xd3, 0x12, 0x0b, 0x3d, 0x53, 0x8c, 0xb2, 0xb9, 0xb8, 0xdc, 0x12, 0x0b,
	0x83, 0x21, 0xb6, 0x09, 0xc5, 0x72, 0xb1, 0x41, 0x74, 0x09, 0xc9, 0xeb, 0xa1, 0x3b, 0x45, 0x0f,
	0xc5, 0x3c, 0x29, 0x21, 0x84, 0x02, 0x90, 0xcb, 0xf4, 0xdc, 0x12, 0x0b, 0x95, 0xe4, 0x9a, 0x2e,
	0x3f, 0x99, 0xcc, 0x24, 0x21, 0x24, 0xa6, 0x0f, 0x77, 0x75, 0x5a, 0x62, 0xa1, 0x7e, 0x35, 0xc4,
	0xe2, 0x5a, 0x27, 0xb1, 0x28, 0x11, 0x74, 0xdf, 0x83, 0x14, 0x24, 0xb1, 0x81, 0xdd, 0x6c, 0x0c,
	0x08, 0x00, 0x00, 0xff, 0xff, 0x40, 0x8f, 0x49, 0x87, 0x1c, 0x01, 0x00, 0x00,
}
