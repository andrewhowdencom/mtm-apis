...
type FaqServiceClient interface {
	GetFaq(ctx context.Context, in *GetFaqRequest, opts ...grpc.CallOption) (*v1alpha2_types.Faq, error)
}
...
func (c *faqServiceClient) GetFaq(ctx context.Context, in *GetFaqRequest, opts ...grpc.CallOption) (*v1alpha2_types.Faq, error) {
	out := new(v1alpha2_types.Faq)
...
type FaqServiceServer interface {
	GetFaq(context.Context, *GetFaqRequest) (*v1alpha2_types.Faq, error)
}
...
func init() { proto.RegisterFile("v1alpha2/services/faq.proto", fileDescriptor0) }
